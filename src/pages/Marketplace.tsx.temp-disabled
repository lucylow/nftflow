  ...
  const loadNFTs = async () => {
    ...
    try {
      ...
      const transformedNFTs = availableNFTs.map((nft, index) => ({
        ...
        pricePerSecond: Number(nft.pricePerSecond || 0.000001),
        isRented: false,
        owner: nft.owner,
        ...
        minDuration: String(nft.minDuration || 3600),
        maxDuration: String(nft.maxDuration || 2592000),
        collateralRequired: String(nft.collateralRequired || 0.1),
