          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {innovationHighlights.map((highlight, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 group-hover:scale-105 bg-slate-800/50 border-slate-700">
      ...
      <div className="py-16 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 lg:grid-cols-3 mb-8 bg-slate-800">
                  ...
                  >
                    <Card className={`h-full hover:shadow-xl transition-all duration-300 group-hover:scale-105 bg-slate-800/50 border-slate-700 ${
                      ...
                      <CardContent className="p-6">
                        ...
                        <Button 
                          variant="outline" 
                          className="w-full mt-4 group-hover:bg-blue-50 border-slate-600 text-white hover:bg-slate-700"
                          onClick={(e) => {
                            e.stopPropagation();
            ...
            <TabsContent value="features" className="space-y-8">
              {selectedFeature && creativeFeatures.find(f => f.id === selectedFeature)?.component ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-white">Select a Feature to Explore</h3>
                  <p className="text-gray-400">Choose a feature from the overview to see it in action</p>
                </div>
              )}
            </TabsContent>
            ...
            <TabsContent value="demo" className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <Card className="bg-slate-800/50 border-slate-700">
                  ...
                  <CardContent>
                    <div className="aspect-video bg-gradient-to-br from-blue-900/50 to-purple-900/50 rounded-lg flex items-center justify-center mb-4">
                      <div className="text-center">
                        <Play className="w-16 h-16 mx-auto text-blue-400 mb-2" />
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="p-4 bg-green-900/30 rounded-lg border border-green-700">
                        <h4 className="font-semibold text-green-400 mb-2">Quick Start</h4>
                        <p className="text-sm text-green-300">
                          Connect your wallet and start exploring NFTFlow's creative features
                        </p>
                      </div>
                      <div className="p-4 bg-blue-900/30 rounded-lg border border-blue-700">
                        <h4 className="font-semibold text-blue-400 mb-2">Testnet Available</h4>
