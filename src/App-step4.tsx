...
// Import only the Marketplace component to test
...
const AppStep4 = () => {
  console.log('AppStep4 component rendering - testing Marketplace component');
