...
const AppWorking = () => {
  ...
  try {
                  ...
                  <BrowserRouter>
                    <Layout>
                      <Routes>
                        ...
                        <Route path="/marketplace" element={<WorkingIndex />} />
                        <Route path="/create" element={<WorkingIndex />} />
                        <Route path="/dashboard" element={<WorkingIndex />} />
                        <Route path="/profile" element={<WorkingIndex />} />
                        <Route path="/wallet" element={<WorkingIndex />} />
                        <Route path="/wallet-test" element={<WorkingIndex />} />
                        <Route path="/somnia" element={<WorkingIndex />} />
                        <Route path="/dao" element={<WorkingIndex />} />
                        <Route path="/governance" element={<WorkingIndex />} />
                        <Route path="/analytics" element={<WorkingIndex />} />
                        <Route path="/upload" element={<WorkingIndex />} />
                        <Route path="/creativity" element={<WorkingIndex />} />
                        <Route path="/subgraph" element={<WorkingIndex />} />
                        <Route path="/social" element={<WorkingIndex />} />
                        <Route path="/mobile" element={<WorkingIndex />} />
                        <Route path="/rental" element={<WorkingIndex />} />
    ...
    console.error('AppWorking rendering error:', error);
    return (
