...
export const Web3Provider: React.FC<Web3ProviderProps> = ({ children }) => {
  ...
  const connectWallet = async () => {
    console.log('🔌 Starting robust wallet connection...');
    ...
    try {
      ...
      const accounts = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Connection timeout - please try again')), 8000) // 8 seconds
        )
      ]);
      ...
      console.log('🎉 Robust wallet connection completed successfully');
